...
export default async function TenantHistoryMaintenanceEventPage({
  params,
}: {
  ...
  return (
    <div className="space-y-6">
      ...
      <BackButton fallback="/tenant/history" label="Back to previous service & work orders" />
      ...
      <div className="flex flex-wrap items-center gap-2">
        {isCompleted ? (
          ...
          <Badge className="border-transparent bg-muted text-muted-foreground">Past</Badge>
        )}
        {appl?.name ? (
